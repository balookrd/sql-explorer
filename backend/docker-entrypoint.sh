...
echo "[entrypoint] Запуск sql-explorer контейнера..."
...
KEYTAB="${KRB5_KEYTAB:-/etc/security/keytabs/sql-explorer.keytab}"
PRINCIPAL="${KRB5_PRINCIPAL:-svc_sql_explorer@COMPANY.LOCAL}"
